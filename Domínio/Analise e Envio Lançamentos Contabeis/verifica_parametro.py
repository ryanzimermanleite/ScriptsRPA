# -*- coding: utf-8 -*-
# ----------------------------------------------------------------------#
# Nome:     Verifica Parametro                                          #
# Arquivo:  verifica_parametro.py                                       #
# Versão:   1.0.0                                                       #
# Modulo:   Dominio                                                     #
...
def parametro(empresa, andamentos):
    cod, cnpj = empresa
    ...
    if cliente[2] == '3' or fornecedor[2] == '3':
        ...
        _escreve_relatorio_csv(';'.join([cod, cnpj, 'Parametro Correto']), nome=andamentos)
        p.press('esc', presses=5)
        return 'ok'
...
def run(window):
    ...
    andamentos = 'Resultado_Parametro'
    ...
    for count, empresa in enumerate(empresas[index:], start=1):
        ...
        while True:
            ...
            resultado = parametro(empresa, andamentos)
